...
import heroImg from "./images/pic2.jpeg";
...
export default function Hero({}: Props) {
    const {text, count} = useTypewriter({
        words: [
            "Hi, My name is Yasir Obaidullah",
    ...
    <div className="h-screen flex flex-col space-y-8 items-center justify-center text-center"> {/* overflow-hidden will adjust circle to more up*/}
        <BackgroundCircles/>
        <div className="relative h-32 w-32 mx-auto object-cover"> {/* same as below rounded-full is not supported in div */}
