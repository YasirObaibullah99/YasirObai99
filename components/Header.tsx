  ...
  return (
    <header className='sticky top-0 p-5 flex items-center justify-between max-w-7xl mx-auto z-20 xl:items-center'> {/* To keep both divs in single line */}
        ...
        className="flex flex-row items-center">
            {/* Social Icons */}
            <SocialIcon url="https://github.com/yasirobai99" fgColor='gray' bgColor='transparent'
            ...
            <SocialIcon url="https://twitter.com/yasirobai99" target="_blank" rel="noopener noreferrer"
            fgColor='gray' bgColor='transparent'/>
            <SocialIcon url="https://www.linkedin.com/in/yasir-obaibullah99/" target="_blank" rel="noopener noreferrer"
            fgColor='gray' bgColor='transparent'/>
        </motion.div>
        <Link href="#contact">
        <motion.div
