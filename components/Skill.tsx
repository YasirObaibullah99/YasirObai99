...
function Skill({ directionLeft }: Props) {
    return(
     ...
     className=" rounded-full border border-gray-500 object-cover w-24 h-24 md:w-32 md:h-32 xl:w-20 xl:h-20 filter group-hover:grayscale transition duration-300 ease-in-out"
     />
