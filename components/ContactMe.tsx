...
const onSubmit: SubmitHandler<Inputs> = formData =>{
    window.location.href = 'mailto: yasirobai99@gmail?subject=${formData.subject}&body=Hi, my name is ${formData.name}. ${FormData.message} (${FormData.email})';
};
        ...
        <div className="relative top-32 text-center items-center flex flex-col space-y-3">
            ...
            <div className="relative ">
                ...
                <div className="flex items-center space-x-3 justify-center">
                    ...
                    <p className="text-1xl">+91-97******26</p>
                </div>
                <div className="flex items-center space-x-3 justify-center">
                    <EnvelopeIcon className="text-[#F7AB0A] h-7 w-7 animate-pulse"/>
                    <p className="text-1xl">yasirobai99@gmail.com</p>
                </div>
