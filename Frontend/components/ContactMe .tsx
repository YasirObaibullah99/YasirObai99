...
export default function ContactMe({ }: Props) {
    ...
    const onSubmit: SubmitHandler<Inputs> = (formData) => {
        window.location.href = `mailto:yasirobaidullah123@gmail.com?subject=${formData.subject}&body=Hi,my name is${formData.name}. ${formData.message} (${formData.email})`;
    };
    ...
    return (
        <div className="h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center">
            ...
            <div className="flex flex-col space-y-10 xl:space-y-0 xl:pt-10">
                ...
                <div className="space-y-7 xl:pt-6 xl:pb-6">
                    ...
                    <div className="flex items-center space-x-4 justify-center">
                        ...
                        <p className="text-2xl">yasirobaidullah123@gmail.com</p>
                    </div>
